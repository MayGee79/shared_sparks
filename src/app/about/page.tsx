    ...
    <main style={{ backgroundColor: '#eef7ff' }} className="min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="py-2 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-6">
              <Link href="/auth/login" className="px-6 py-2 text-[#55b7ff] border-2 border-[#55b7ff] hover:bg-[#f4b941] hover:border-[#f4b941] hover:text-white rounded-md transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                Sign In
              </Link>
              <Link href="/auth/register" className="px-6 py-2 text-[#6735b1] border-2 border-[#6735b1] hover:bg-[#f4b941] hover:border-[#f4b941] hover:text-white rounded-md transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                Register
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          {/* Header */}
          <h1 className="text-4xl font-bold text-[#100359] mb-8">About Shared Sparks</h1>
